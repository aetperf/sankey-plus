      ...
      nodesSourceLinks.sort(function (link1, link2) {
        ...
        if (!link1.circular && !link2.circular) {
          ...
          if (link1.target.column == link2.target.column) {
            ...
            var angle2 = Math.atan2(link2.target.y0 - link2.source.y0, link2.target.x0 - link2.source.x0);

            // Compare angles to determine the sorting order
...
export function sortLinks(inputGraph, id) {
  let g = inputGraph;
